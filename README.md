...
`Option.ofNull` rather than `Option.ofObj` is used consistently for .NET types. Strings may also be handled with the help of `string`, `Option.ofNullEmpty` or `Option.NullEmptySpace`.  
